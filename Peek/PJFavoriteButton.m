...
@interface PJFavoriteButton ()

@property (nonatomic, readwrite, strong) CAShapeLayer        * imageShape;
@property (nonatomic, readwrite, strong) CAShapeLayer        * circleShape;
@property (nonatomic, readwrite, strong) CAShapeLayer        * circleMask;
@property (nonatomic, readwrite, strong) NSMutableArray      * lines;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * circleTransform;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * circleMaskTransform;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * lineStrokeStart;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * lineStrokeEnd;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * lineOpacity;
@property (nonatomic, readwrite, strong) CAKeyframeAnimation * imageTransform;

@end

@implementation PJFavoriteButton
...
- (void)select {
    ...
    self.imageShape.mask.contents = (id)[[UIImage imageNamed:@"like"] CGImage];
    ...
    // 点赞tapic
    dispatch_queue_t queue = dispatch_queue_create("favorite", DISPATCH_QUEUE_SERIAL);
...
- (void)deselect {
    ...
    self.imageShape.mask.contents = (id)[[UIImage imageNamed:@"no_like"] CGImage];
